...
window.addEventListener("load", () => {
    ...
    trackSmallCoverImage[0].src = `${q2[0].album.images[2].url}`;
    trackSmallCoverImage[1].src = `${q2[0].album.images[2].url}`;
...
prev.addEventListener("click", () => {
    if(cp == 0){
        ...
        trackSmallCoverImage[0].src = `${q2[q2.length - 1].album.images[2].url}`;
        trackSmallCoverImage[1].src = `${q2[q2.length - 1].album.images[2].url}`;
        ...
        trackSmallCoverImage[0].src = `${q2[cp - 1].album.images[2].url}`;
        trackSmallCoverImage[1].src = `${q2[cp - 1].album.images[2].url}`;
